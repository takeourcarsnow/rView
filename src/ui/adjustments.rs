...
use crate::ui::common;
use egui::{self, Color32, CornerRadius, RichText, Stroke};
...
pub fn render_basic_panel(app: &mut ImageViewerApp, ui: &mut egui::Ui) {
    ...
    common::lr_collapsible_panel(ui, "Basic", true, |ui| {
        ...
        // Temperature
        let (changed, dragging) = common::lr_slider_ex(
            ui,
            "Temp",
        ...
        let (changed, dragging) =
            common::lr_slider_ex(ui, "Saturation", &mut sat_display, -100.0..=100.0, "", 0.0);
        if changed {
            ...
            if ui
                .add(
                    egui::Button::new(RichText::new("Reset").size(10.0).color(LR_TEXT_SECONDARY))
                        .fill(LR_BG_INPUT)
                        .stroke(Stroke::new(1.0, common::LR_BORDER))
...
pub fn render_film_emulation_panel(
    ...
    common::lr_collapsible_panel(ui, "Film Emulation", false, |ui| {
        ui.spacing_mut().slider_width = ui.available_width() - 80.0;
        ...
        if app.adjustments.film.enabled {
            ...
            if common::lr_slider(ui, "Amount", &mut grain_display, 0.0..=100.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "Size", &mut size_display, 25.0..=100.0, "", 50.0) {
            ...
            if common::lr_slider(ui, "Roughness", &mut rough_display, 0.0..=100.0, "", 50.0) {
            ...
            if common::lr_slider(ui, "Amount", &mut vig_display, 0.0..=100.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "Amount", &mut hal_display, 0.0..=100.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "Radius", &mut rad_display, 0.0..=100.0, "", 20.0) {
            ...
            if common::lr_slider(ui, "Shadows", &mut shadows_tc, -100.0..=100.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "Midtones", &mut mids_tc, -100.0..=100.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "Highlights", &mut highs_tc, -100.0..=100.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "S-Curve", &mut scurve, 0.0..=100.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "R→G", &mut rig, -20.0..=20.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "R→B", &mut rib, -20.0..=20.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "G→R", &mut gir, -20.0..=20.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "G→B", &mut gib, -20.0..=20.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "B→R", &mut bir, -20.0..=20.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "B→G", &mut big, -20.0..=20.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "R Gamma", &mut r_gamma, 0.0..=100.0, "", 50.0) {
            ...
            if common::lr_slider(ui, "G Gamma", &mut g_gamma, 0.0..=100.0, "", 50.0) {
            ...
            if common::lr_slider(ui, "B Gamma", &mut b_gamma, 0.0..=100.0, "", 50.0) {
            ...
            if common::lr_slider(ui, "Black Point", &mut bp_display, 0.0..=100.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "White Point", &mut wp_display, 0.0..=100.0, "", 100.0) {
            ...
            if common::lr_slider(ui, "Latitude", &mut lat_display, 0.0..=100.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "Shadow R", &mut shadow_r, -100.0..=100.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "Shadow G", &mut shadow_g, -100.0..=100.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "Shadow B", &mut shadow_b, -100.0..=100.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "High R", &mut highlight_r, -100.0..=100.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "High G", &mut highlight_g, -100.0..=100.0, "", 0.0) {
            ...
            if common::lr_slider(ui, "High B", &mut highlight_b, -100.0..=100.0, "", 0.0) {
